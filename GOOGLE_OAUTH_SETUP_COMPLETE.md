...
3. **Configure Site URLs in Supabase:**
   ...
   Site URL: https://jwt-flow-repair.preview.emergentagent.com
   
   Redirect URLs (add these):
   - https://jwt-flow-repair.preview.emergentagent.com/auth/callback
   - https://jwt-flow-repair.preview.emergentagent.com/
   ```
...
**Frontend:**
```bash
REACT_APP_BACKEND_URL=https://jwt-flow-repair.preview.emergentagent.com
REACT_APP_SUPABASE_URL=https://lvtotvdzlsulgycgupcy.supabase.co
