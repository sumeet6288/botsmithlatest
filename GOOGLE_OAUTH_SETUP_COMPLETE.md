...
3. **Configure Site URLs in Supabase:**
   ...
   Site URL: https://remove-dash-button.preview.emergentagent.com
   
   Redirect URLs (add these):
   - https://remove-dash-button.preview.emergentagent.com/auth/callback
   - https://remove-dash-button.preview.emergentagent.com/
   ```
...
**Frontend:**
```bash
REACT_APP_BACKEND_URL=https://remove-dash-button.preview.emergentagent.com
REACT_APP_SUPABASE_URL=https://lvtotvdzlsulgycgupcy.supabase.co
