...
3. **Configure Site URLs in Supabase:**
   ...
   Site URL: https://login-whitespace.preview.emergentagent.com
   
   Redirect URLs (add these):
   - https://login-whitespace.preview.emergentagent.com/auth/callback
   - https://login-whitespace.preview.emergentagent.com/
   ```
...
**Frontend:**
```bash
REACT_APP_BACKEND_URL=https://login-whitespace.preview.emergentagent.com
REACT_APP_SUPABASE_URL=https://lvtotvdzlsulgycgupcy.supabase.co
