...
3. **Configure Site URLs in Supabase:**
   ...
   Site URL: https://planlogic.preview.emergentagent.com
   
   Redirect URLs (add these):
   - https://planlogic.preview.emergentagent.com/auth/callback
   - https://planlogic.preview.emergentagent.com/
   ```
...
**Frontend:**
```bash
REACT_APP_BACKEND_URL=https://planlogic.preview.emergentagent.com
REACT_APP_SUPABASE_URL=https://lvtotvdzlsulgycgupcy.supabase.co
