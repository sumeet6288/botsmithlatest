...
3. **Configure Site URLs in Supabase:**
   ...
   Site URL: https://subscription-fix-14.preview.emergentagent.com
   
   Redirect URLs (add these):
   - https://subscription-fix-14.preview.emergentagent.com/auth/callback
   - https://subscription-fix-14.preview.emergentagent.com/
   ```
...
**Frontend:**
```bash
REACT_APP_BACKEND_URL=https://subscription-fix-14.preview.emergentagent.com
REACT_APP_SUPABASE_URL=https://lvtotvdzlsulgycgupcy.supabase.co
